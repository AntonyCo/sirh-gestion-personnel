...
public class ListerCollaborateursController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (filtreDepartement.equals("tous")) {
			...
			// Sinon on filtre par numéro de département l'ensemble des collaborateurs
		...
		// FILTRAGE PAR NOM
		// Si le champs est vide on prend l'ensemble des collaborateurs de la liste
		// filtrée par département
		if (filtreNom == null) {
			listeFiltre = listeFiltreDepartement;
		} else {
			// Sinon on filtre par nom ou prénom l'ensemble des collaborateurs de la liste
			// filtrée par département
